...
public class IrCodegenBoxWasmTestGenerated extends AbstractIrCodegenBoxWasmTest {
    ...
    public static class ExtensionClasses extends AbstractIrCodegenBoxWasmTest {
        ...
        public void testAllFilesPresentInExtensionClasses() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler/testData/codegen/box/extensionClasses"), Pattern.compile("^([^_](.+))\\.kt$"), null, TargetBackend.WASM, true);
        }
    ...
    public static class ExtensionFunctions extends AbstractIrCodegenBoxWasmTest {
        ...
        public static class AdditionalReceivers extends AbstractIrCodegenBoxWasmTest {
            ...
            public void testAllFilesPresentInAdditionalReceivers() throws Exception {
                KotlinTestUtils.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler/testData/codegen/box/extensionFunctions/additionalReceivers"), Pattern.compile("^([^_](.+))\\.kt$"), null, TargetBackend.WASM, true);
            }

    ...
    when (descriptorOfThisReceiver) {
        is CallableDescriptor -> {
            val receiverParameters =
                listOfNotNull(descriptorOfThisReceiver.extensionReceiverParameter) + descriptorOfThisReceiver.additionalReceiverParameters.reversed()
            val receiverParameter = receiverParameters.find {
                bindingContext.get(BindingContext.RECEIVER_LABEL_NAME, it.value) == labelName
            }

...
fun IrValueParameterBuilder.build(): IrValueParameter {
    val wrappedDescriptor = org.jetbrains.kotlin.backend.common.descriptors.WrappedValueParameterDescriptor()
    return org.jetbrains.kotlin.ir.declarations.impl.IrValueParameterImpl(
        startOffset, endOffset, origin,
        org.jetbrains.kotlin.ir.symbols.impl.IrValueParameterSymbolImpl(wrappedDescriptor),

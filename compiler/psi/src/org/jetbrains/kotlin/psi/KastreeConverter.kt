...
open class KastreeConverter {
    ...
    open fun convertAnnotationSetTarget(v: KtAnnotationUseSiteTarget) = when (v.getAnnotationUseSiteTarget()) {
        ...
        AnnotationUseSiteTarget.MACRO -> Node.Modifier.AnnotationSet.Target.MACRO
    }
    ...
    open class WithExtras : KastreeConverter(), ExtrasMap {
    ...
    companion object : KastreeConverter() {

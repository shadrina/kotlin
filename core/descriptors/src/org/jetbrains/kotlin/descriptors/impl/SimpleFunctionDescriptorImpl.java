...
public class SimpleFunctionDescriptorImpl extends FunctionDescriptorImpl implements SimpleFunctionDescriptor {
    ...
    public SimpleFunctionDescriptorImpl initialize(
        ...
        return initialize(extensionReceiverParameter, dispatchReceiverParameter, additionalReceiverParameters, typeParameters, unsubstitutedValueParameters,
    ...
    public SimpleFunctionDescriptorImpl initialize(
        ...
        super.initialize(extensionReceiverParameter, dispatchReceiverParameter, additionalReceiverParameters, typeParameters, unsubstitutedValueParameters,
